...
function ordered18(){
    ...
    t19.innerText="your ordered has been placed";
...
function bill()
{
    ...
    let s1=s*170;
    let tm1=tm*150;
    let total=a1+b1+c1+da1+e1+f1+g1+h1+i1+j1+k1+l1+ma1+n1+o1+p1+q1+r1+s1+tm1;
    ...
    if(da>0)
    {
        ...
        document.write("<td> " +da+"</td>");
        document.write("<td>70</td>");
        document.write("<td> " +da1+"</td>");
        document.write("</tr>");
    ...
    {
        document.write("<tr>");
        document.write("<td>Naan</td>");
        document.write("<td> " +k+"</td>");
        document.write("<td>100</td>");
        document.write("<td> " +k1+"</td>");
        document.write("</tr>");
    ...
    {
        document.write("<tr>");
        document.write("<td>Panner Butter Masala Gravy</td>");
    ...
    {
        document.write("<tr>");
        document.write("<td>Chicken Fried Rice</td>");
        document.write("<td> " +ma+"</td>");
        document.write("<td>150</td>");
        document.write("<td> " +ma1+"</td>");
        document.write("</tr>");
    ...
    {
        document.write("<tr>");
        document.write("<td>Mushroom FriedRice</td>");
    ...
    {
        document.write("<tr>");
        document.write("<td>Chicken Noodles</td>");
        document.write("<td> " +o+"</td>");
        document.write("<td>150</td>");
        document.write("<td> " +o1+"</td>");
        document.write("</tr>");
    ...
    {
        document.write("<tr>");
        document.write("<td>Mushroom Noodles</td>");
    ...
    {
        document.write("<tr>");
        document.write("<td>Chilli Parotta</td>");
        document.write("<td> " +q+"</td>");
        document.write("<td>170</td>");
    ...
    {
        document.write("<tr>");
        document.write("<td>Ice Cream</td>");
        document.write("<td> " +r+"</td>");
        document.write("<td>130</td>");
    ...
    {
        document.write("<tr>");
        document.write("<td>Milkshake</td>");
    ...
    {
        document.write("<tr>");
        document.write("<td>Fresh Juice</td>");
